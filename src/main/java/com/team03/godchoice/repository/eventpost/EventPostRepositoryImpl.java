...
@Repository
public class EventPostRepositoryImpl extends MakeRegionTagClass implements SearchInterface {
    ...
    public PageImpl<?> toPage(List<EventPost> eventPostList, Pageable pageable, Member member) {
